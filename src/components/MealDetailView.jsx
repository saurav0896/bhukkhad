    ...
    return (
        <div className="mx-auto max-w-2xl px-4  sm:px-6 sm:py-12 lg:max-w-7xl lg:px-8 overflow-hidden">
            <div className='flex justify-between'>
                <h2 className="text-2xl font-bold tracking-tight text-gray-900">Random Recipe <span aria-hidden="true">&rarr;</span></h2>
            ...
            <nav aria-label="Breadcrumb">
                {isLoading ? <div className='flex'>
                    <Skeleton width={60} /> / <Skeleton width={90} /> / <Skeleton width={130} />
                </div> : <>
                    <ol role="list" className="mx-auto flex max-w-2xl items-center space-x-2 px-4 py-2 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <div className="mx-auto mt-6 max-w-2xl min-h-72 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
                <div className="aspect-h-2 aspect-w-3 hidden overflow-hidden rounded-lg lg:block">
                    {isLoading ? <Skeleton width={300} height={500} /> :
                        <img
                ...
                <div className="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
                    <div className="aspect-h-1 aspect-w-3 overflow-hidden rounded-lg">
                        {isLoading ? <Skeleton width={300} height={300} /> :
                            <img
                                src={product.images[0].src}
                                alt={product.images[0].alt}
                                className="h-full w-full object-cover object-center"
                ...
                <div className="mt-4 lg:row-span-3 lg:mt-0">
                    ...
                    <form className="mt-10">
                        ...
                        {isLoading ? <>
                            ...
                            <div>
                                <h3 className="text-sm font-lg text-gray-900 font-bold">Tag :</h3>
